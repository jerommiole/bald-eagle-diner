    ...
    <div className="bg-blue">
      <div className="p-6 lg:p-20 gap-8 lg:gap-6 flex flex-col items-center mx-auto lg:max-w-7xl">
        ...
        <div className="flex gap-4">
          <Link
            href="https://www.facebook.com/BEDiner/"
            target="_blank"
          ...
          <Link
            href="https://www.instagram.com/baldeaglediner"
            target="_blank"
            className="footer-icons"
          >
            <svg
        ...
        <p className="text-center text-offwhite text-sm">
          ©{currentYear} Bald Eagle Diner. All Rights Reserved.
        </p>
      </div>
    </div>
  );
